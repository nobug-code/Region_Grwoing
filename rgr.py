    ...
    while (len(list1) > 0):
        ...
        for coord in get8n(pix[0], pix[1], img.shape):
            if (coord[0] < h - 1 and coord[1] < w - 1):
                ...
                if ((ans[0] > rm and ans[0] < rp) and (ans[1] > gm and ans[1] < gp) and (
                        ans[2] > bm and ans[2] < bp)):  ## if == val at that pixel.........do algo
...
if __name__ == '__main__':
    ...
    seed = [(0, 0), (0, w), (2 * w, 0), (h, 0), (h, w), (h, 2 * w), (2 * h, 0), (2 * h, w),
            (2 * h, 2 * w)]  # stating seed points
